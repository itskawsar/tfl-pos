...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->foreignId('brand_id')->unsigned()->constrained('brands')->onDelete('cascade');
            ...
            $table->foreignId('sub_category_id')->unsigned()->nullable()->constrained('categories')->onDelete('cascade');

            // $table->integer('tax')->unsigned()->nullable();
            // $table->foreign('tax')->references('id')->on('tax_rates');
            $table->foreignId('tax')->nullable()->constrained('tax_rates')->onDelete('cascade');
